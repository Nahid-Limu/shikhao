    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div id="create-new" class="modal-body">
                {!! Form::open(['method'=>'POST', 'action'=>'ClassTableController@store']) !!}
                <div class="form-group">
                    {!! Form::label('name','Class Name:') !!}<span class='require'>*</span>
                    {!! Form::text('name',null,['class'=>'form-control','required'=>'', 'placeholder'=>'Enter Class Name']) !!}

                </div>

                <div class="form-group">
                    <label for="medium_id">Medium:</label><br>
