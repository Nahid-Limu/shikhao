<div class="modal fade" id="addSubjectO" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog animated pulse" role="document">
        <div class="modal-content">
            ...
            <div id="create-new" class="modal-body">
                {!! Form::open(['method'=>'POST', 'action'=>'SubjectResultController@store_o_level','id'=>'store_o_level']) !!}
                ...
                <div style="border-top:0px;" class="modal-footer">
                    ...
                    <button id="save-btn-o" type="Submit" class="btn btn-blue">Save</button>
                </div>
                {!! Form::close() !!}
            </div>
